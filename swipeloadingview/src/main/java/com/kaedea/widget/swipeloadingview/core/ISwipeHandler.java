...
public interface ISwipeHandler {
    ...
    void hideLoadingView(boolean isShowAnimation, int direction, IAnimationHandler.OnSwipeAnimationListener listener);

    void showLoadingView(boolean isShowAnimation, int direction, IAnimationHandler.OnSwipeAnimationListener listener);
